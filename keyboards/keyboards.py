...
buttons_4 = [types.InlineKeyboardButton(text="Список вакансий", callback_data="gen_vacancy"),
            ...
            types.InlineKeyboardButton(text="Сотрудники", callback_data="gen_employee_list"),
            types.InlineKeyboardButton(text="Поощрения/штрафы", callback_data="gen_award_list"),
            types.InlineKeyboardButton(text="Контракты", callback_data="gen_contract_list"),
